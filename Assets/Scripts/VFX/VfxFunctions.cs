...
public static class VfxFunctions 
{
    ...
    public static GameObject VisualiseVfxColorVoxels(MultiValueVoxelModel voxelModel, float voxelSize, VoxelVisualizationType vfxVisType)
    {
